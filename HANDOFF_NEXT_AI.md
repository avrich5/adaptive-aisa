...
Прочитати ПЕРШИМ, потім `DEV_PLAN.md` (три лінії + дві цілі) і `CLAUDE.md` (журнал рішень — авторитетний).
...
1. **analysis/ — кластеризація (gate інструмента, НЕ головна метрика проєкту).** Чи розходяться 3 мовчання
